...
class MyGardenTile extends StatefulWidget {
 
  @override
  _MyGardenTileState createState() => _MyGardenTileState();


}

class _MyGardenTileState extends State<MyGardenTile> {
  ...
  Widget build(BuildContext context) {
    return myGardenTile(context, 3, "Plant Name", "Scientific Name");
  }
}
